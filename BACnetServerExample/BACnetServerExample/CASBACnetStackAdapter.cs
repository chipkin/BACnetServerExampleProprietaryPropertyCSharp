...
namespace BACnetStackDLLServerCSharpExample
{
    ...
    {
        const string ADAPTER_VERSION = "0.0.10";
        ...
        */
        ...
        [DllImport(BACNET_API_DLL_FILENAME, EntryPoint = "BACnetStack_SetProprietaryProperty", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool SetProprietaryProperty(UInt32 deviceInstance, UInt16 objectType, UInt32 objectInstance, UInt32 propertyIdentifier, bool required, bool writable, UInt32 dataType, bool isArray, bool isList, bool subscribable);
